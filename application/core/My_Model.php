...
class My_Model extends CI_Model {
    ...
    */
    public function validate() {
        ...
        $this->form_validation->set_error_delimiter(
            '<small class="form-text text-danger">', '</small>'
        );
        $validationRules = $this->getValidatorRules();
    ...
    public function makePagination($baseUrl, $urlSegment, $totalRows = null){
        ...
        $config = [
            ...
            'last_tag_close' => '</li>',
            'cur_tag_open' => '<li class="page-item active"><a href="#" class="page-item>',
